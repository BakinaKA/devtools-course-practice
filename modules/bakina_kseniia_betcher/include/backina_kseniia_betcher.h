...
void residue_handling(int iter, const std::vector<int>& vec, std::vector<int>& res);
void partial_merger(int iter_init, const std::vector<int>& vec1, const std::vector<int>& vec2,
    std::vector<int>& res, bool comparator(int, int) = default_comparator);
std::vector<int> EvenOddBetcher_merge(const std::vector<int>& v1, const std::vector<int>& v2,
