...
TEST(Bakina_Kseniia_OddEvenBetcherConfluenceTest, check_func_get_random_vector) {
	int n = 10;
...
TEST(Bakina_Kseniia_OddEvenBetcherConfluenceTest, check_func_residue_handling) {
...
TEST(Bakina_Kseniia_OddEvenBetcherConfluenceTest, check_func_partial_merger_with_default_comparator) {
...
TEST(Bakina_Kseniia_OddEvenBetcherConfluenceTest, check_func_partial_merger_with_custom_comparator) {
...
TEST(Bakina_Kseniia_OddEvenBetcherConfluenceTest, check_func_EvenOddBetcher_merge_with_default_comparator) {
...
TEST(Bakina_Kseniia_OddEvenBetcherConfluenceTest, check_func_EvenOddBetcher_merge_with_custom_comparator) {
	std::vector<int> vector1 = get_random_vector(100);
	std::vector<int> vector2 = get_random_vector(150);
	...
	auto custom_comparator_greater = [](int a, int b) { return a > b; };
	std::vector<int> result = EvenOddBetcher_merge(vector1, vector2, custom_comparator_greater);
